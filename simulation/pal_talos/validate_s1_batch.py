...
Protocole (chapitre methodologie) : tenir debout sous poussees externes ; succes > 90 % sur
...
Ajouts 2026-07-16 (backup : validate_s1_batch_BACKUP_20260716.py) :
  - recovery time t_rec par essai (metrique S1 ancree dans la methodologie, jamais chiffree) :
