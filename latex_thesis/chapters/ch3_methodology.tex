...
% ─── 3.8 EVALUATION PROTOCOL (S1–S5) ────────────────────────
\section{Evaluation Protocol}
\label{sec:eval-protocol}

% Define the 5 scenarios S1–S5, standardised metrics, and baseline definitions.
% This section is the primary home of Contribution C2.

\lipsum[25]

\begin{criticalinsight}
  % TODO: Justify metric selection from benchmark literature (PQ6 — benchmark\_metrics.md).
  % All thresholds must be anchored in cited values before Ch5 is written.
\end{criticalinsight}
