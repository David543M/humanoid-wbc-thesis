...
qu'elle est verrouillée (the thesis scope definitionRQ) : la *simultanéité* locomotion + manipulation. S1 (équilibre),
...
1. **Où injecter la tâche EE ?** La formulation QP-WBC absorbe naturellement une tâche
   ...
   c'est précisément l'avantage revendiqué du QP-WBC sur le task-switching (the thesis methodology chapter).
